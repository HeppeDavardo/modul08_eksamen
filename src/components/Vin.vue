        ...
        .then(() => {
            ...
            .then(data => { 
                ...
                for (let i = data.length-1; i >= 0; i--) {
                    ...
                    <h3>${data[i].acf.pris2}</h3>
                    <h3>${data[i].acf.navn3}</h3>
                    <p>${data[i].acf.ingredienser3}</p>
                    <h3>${data[i].acf.pris3}</h3>
                    <h3>${data[i].acf.navn4}</h3>
                    <p>${data[i].acf.ingredienser4}</p>
                    <h3>${data[i].acf.pris4}</h3>
                    <h3>${data[i].acf.navn5}</h3>
                    <p>${data[i].acf.ingredienser5}</p>
                    <h3>${data[i].acf.pris5}</h3>
                    <h3>${data[i].acf.navn6}</h3>
                    <p>${data[i].acf.ingredienser6}</p>
                    <h3>${data[i].acf.pris6}</h3>
                    <h3>${data[i].acf.navn7}</h3>
                    <p>${data[i].acf.ingredienser7}</p>
                    <h3>${data[i].acf.pris7}</h3>
                    <h3>${data[i].acf.navn8}</h3>
                    <p>${data[i].acf.ingredienser8}</p>
                    <h3>${data[i].acf.pris8}</h3>
                    `;
                }
            });
        });
